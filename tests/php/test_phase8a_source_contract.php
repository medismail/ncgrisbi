...
phase8a_check(str_contains($panel, 'syncEditorDraft(props.draft, value)'), 'local draft is not synchronized with pending batch state');
...
phase8a_check(str_contains($draftMutations, 'syncEditorDraft'), 'local draft synchronization helper is missing');
