...
from ._snapshot_core import build_account_snapshot as _build_account_snapshot

# Compact transaction indexes shared with _snapshot_core.py / snapshotWire.mjs.
_TX_AMOUNT = 3
_TX_PARTY_ID = 4
_TX_CATEGORY_ID = 5
...
def build_account_snapshot(document: Any, account_id: Any) -> Dict[str, Any]:
    """Build the canonical editor snapshot with current-account precedence."""
