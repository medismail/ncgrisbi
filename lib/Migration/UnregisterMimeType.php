...
class UnregisterMimeType extends MimeTypeMigration
{
    ...
    {
        return 'Unregister MIME type for "application/x-gsb"';
    }
    ...
    private function unregisterForNewFiles()
    {
        ...
        $this->removeFromFile($mimetypealiasesFile, ['application/x-gsb' => 'gsb']);
        $this->removeFromFile($mimetypemappingFile, ['gsb' => ['application/x-gsb']]);
    }
