<template>
  <NcAppNavigation>
    <template #list>
      <NcAppNavigationItem name="Accounts overview" to="/accounts">
        <template #icon>
  ...
  <NcAppContent id="app-content" app-name="ncgrisbi">
    ...
    <NcEmptyContent v-else-if="accountError" :icon="AlertCircle">
      <template #desc>
...
.error-state { display: grid; gap: 14px; max-width: 520px; }
